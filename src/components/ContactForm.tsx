      ...
      <form onSubmit={handleSubmit} noValidate ref={formRef}>
        <div className="grid grid-cols-1 gap-x-8 gap-y-6">
          ...
          >
            ...
            <Button
              className={`w-full rounded-md border-2 text-xl font-bold text-white uppercase px-6 py-3 text-center 
                ${isSubmitting 
                  ? 'bg-gray-400 cursor-not-allowed border-gray-400' 
                  : 'border-[#0E8168] bg-[#0E8168] hover:bg-[#001d2f] hover:border-[#001d2f]'}`}
              type="submit"
              disabled={isSubmitting}
            >
